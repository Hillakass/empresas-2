	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					"bg-destructive/75 shadow-xs hover:bg-destructive/65 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 text-white",
				outline:
